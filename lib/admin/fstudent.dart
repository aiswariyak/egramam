...
class fstudent extends StatefulWidget {

  @override
  _fstudentState createState() => _fstudentState();
}

class _fstudentState extends State<fstudent> {
  @override
      ...
      body: SafeArea(
        child:  StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('Members')
                .where('status',isEqualTo: 1).where('student',isEqualTo: true).snapshots(),
