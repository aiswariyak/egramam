...
class _findpatientState extends State<findpatient> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Color(0xffdcedc8), //0xffd7ccc8//0xfff8bbd0
      appBar: AppBar(
      ...
      body: SafeArea(
        child:  StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('Members')
                .where('status',isEqualTo: 1).where('diseasetype',isEqualTo: widget.disease).snapshots(),
