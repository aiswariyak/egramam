...
class fladies extends StatefulWidget {

  @override
  _fladiesState createState() => _fladiesState();
}

class _fladiesState extends State<fladies> {
  @override
      ...
      body: SafeArea(
        child:  StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('Members')
                .where('status',isEqualTo: 1).where('gender',isEqualTo: 'Female').snapshots(),
