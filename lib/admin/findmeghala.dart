...
class findmeghala extends StatefulWidget {
  var Meghala;
  findmeghala({this.Meghala});

  @override
  _findmeghalaState createState() => _findmeghalaState();
}

class _findmeghalaState extends State<findmeghala> {
  @override
      ...
      body: SafeArea(
        child:  StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('Members')
                .where('status',isEqualTo: 1).where('Meghala',isEqualTo: widget.Meghala).snapshots(),
